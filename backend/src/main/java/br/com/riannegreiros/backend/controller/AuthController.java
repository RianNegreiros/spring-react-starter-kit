...
import br.com.riannegreiros.backend.dto.request.LoginRequest;
import br.com.riannegreiros.backend.dto.request.UserRegisterRequest;
import br.com.riannegreiros.backend.dto.response.ErrorResponse;
import br.com.riannegreiros.backend.dto.response.LoginResponse;
import br.com.riannegreiros.backend.dto.response.UserRegisterResponse;
...
public class AuthController {
    ...
    public ResponseEntity<Object> register(@Valid @RequestBody UserRegisterRequest request) {
        ...
        try {
            ...
            String token = tokenConfig.generateToken(newUser); // Optional: auto-login
